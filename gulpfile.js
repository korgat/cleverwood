...
const a_assets = gulp.parallel(vendors, c_font, copyImages, convertImagesToWebp);
const b_images = gulp.parallel(copyImages, convertImagesToWebp)
const build = gulp.parallel(html, js, styles, stylesCSS, vendors, c_font, copyImages, convertImagesToWebp);

export {c_font, a_assets, build, clean, b_images }
